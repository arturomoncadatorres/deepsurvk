#!/usr/bin/env python
#
# deepsurvk documentation build configuration file, created by
...
project = 'DeepSurvK'
copyright = '2020-{},  Arturo Moncada-Torres'.format(date.today().year)
...
version = deepsurvk.__version__
# The full version, including alpha/beta/rc tags.
release = deepsurvk.__version__
...
htmlhelp_basename = 'deepsurvkdoc'
...
latex_documents = [
    (master_doc, 'deepsurvk.tex',
     'DeepSurvK Documentation',
     'Arturo Moncada-Torres', 'manual'),
]
